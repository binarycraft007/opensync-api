...
type IntegrationHealthCheckApiService service

/*
IntegrationHealthCheckApiService Integration Health check API 2.0
&lt;div&gt;&lt;strong&gt;200&lt;/strong&gt;: Success, Integration intact.&lt;/div&gt; &lt;div&gt;&lt;strong&gt;401&lt;/strong&gt;: Unauthorized&lt;/div&gt;
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().


*/
func (a *IntegrationHealthCheckApiService) IntegrationHealthCheckCheckIntegration(ctx context.Context) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/checkIntegrationHealth"
