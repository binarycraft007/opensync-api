...
// HomepassCustomerSupportConfigurations homepass customer support configurations
//
// swagger:model homepassCustomerSupportConfigurations
type HomepassCustomerSupportConfigurations struct {
...
// Validate validates this homepass customer support configurations
func (m *HomepassCustomerSupportConfigurations) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HomepassCustomerSupportConfigurations) validateID(formats strfmt.Registry) error {
...
func (m *HomepassCustomerSupportConfigurations) validateUpdatedAt(formats strfmt.Registry) error {
...
// ContextValidate validate this homepass customer support configurations based on the context it is used
func (m *HomepassCustomerSupportConfigurations) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HomepassCustomerSupportConfigurations) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HomepassCustomerSupportConfigurations) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HomepassCustomerSupportConfigurations) UnmarshalBinary(b []byte) error {
	var res HomepassCustomerSupportConfigurations
