...
// WithWhere adds the where to the customer count params
func (o *CustomerCountParams) WithWhere(where *string) *CustomerCountParams {
	o.SetWhere(where)
	return o
}

// SetWhere adds the where to the customer count params
func (o *CustomerCountParams) SetWhere(where *string) {
	o.Where = where
}
